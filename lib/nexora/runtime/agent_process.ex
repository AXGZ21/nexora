defmodule Nexora.Runtime.AgentProcess do
  @moduledoc """
  ...
  alias Nexora.Runtime.LLMClient
  ...
  defp via_tuple(id), do: {:via, Registry, {Nexora.AgentRegistry, id}}
  ...
  defp default_system_prompt do
    "You are a helpful AI assistant running inside Nexora. Be concise, accurate, and helpful."
  end
end
