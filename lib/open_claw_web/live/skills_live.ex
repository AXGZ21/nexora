defmodule OpenClawWeb.SkillsLive do
  use OpenClawWeb, :live_view

  alias OpenClaw.Skills.SkillRegistry
  ...
  defp marketplace_skills do
    [
      %{id: "image-gen", name: "Image Generation", description: "Generate images using DALL-E, Stable Diffusion", version: "1.2.0", author: "OpenClaw", downloads: 12400},
      ...
      %{id: "git-ops", name: "Git Operations", description: "Manage git repositories and automate workflows", version: "1.5.0", author: "OpenClaw", downloads: 15600},
      ...
      %{id: "db-query", name: "Database Query", description: "Query PostgreSQL, MySQL, and SQLite databases", version: "1.3.0", author: "OpenClaw", downloads: 9400},
