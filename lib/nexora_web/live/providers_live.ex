defmodule NexoraWeb.ProvidersLive do
  use NexoraWeb, :live_view

  alias Nexora.Runtime.CustomProvider
  alias Nexora.Runtime.ProviderConfig
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(Nexora.PubSub, "providers")
      Phoenix.PubSub.subscribe(Nexora.PubSub, "provider_config")
    end
